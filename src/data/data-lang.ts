...
export const dataLang: ILocalizationContext['dataLang'] = {
  ...
  BE: {
    ...
    editor: 'Рэдактар',
    response: 'Адказ',
    prettify: 'Фарматаваць запыт',
    sendQuery: 'Адправіць запыт',
    variables: 'Зменныя',
    headers: 'Загалоўкі',
    ...
    team: {
      ...
      Sergey: 'Сяргей',
      RomanDesc:
        'Раман - рухаючая сіла тэхнічнай перавагі нашага прадукта. Яго стратэгічнае мысленне і лідэрства сыгралі важную ролю ў фармаванні нашага поспеху',
      KristinaDesc:
